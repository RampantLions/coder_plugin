<!-- BEGIN LiminalCognition LLC CHANGELOG.MD V0.0.5 BLOCK -->
...
#### Added
- Initial project scaffold generated for **Coder Plugin**.
...
To install the latest version of Coder Plugin simply run:

`pip3 install Coder Plugin`

OR

`poetry add Coder Plugin`

OR

`pipenv install Coder Plugin`
